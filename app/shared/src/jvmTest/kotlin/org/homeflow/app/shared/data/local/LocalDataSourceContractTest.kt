...
class LocalDataSourceContractTest {
    ...
    @Test
    fun `getMe returns success with fixed user id`() = runTest {
        val result = ds().getMe()
    ...
    @Test
    fun `getCycles returns empty list initially`() = runTest {
    ...
    @Test
    fun `getCurrentCycle returns NOT_FOUND when no open cycle`() = runTest {
    ...
    @Test
    fun `createCycle creates an open cycle`() = runTest {
        val ds = ds()
    ...
    @Test
    fun `createCycle auto-closes previous open cycle`() = runTest {
        val ds = ds()
    ...
    @Test
    fun `closeCycle sets end date`() = runTest {
        val ds = ds()
    ...
    @Test
    fun `closeCycle unknown id returns NOT_FOUND`() = runTest {
    ...
    @Test
    fun `createCycle future date returns VALIDATION_ERROR`() = runTest {
    ...
    @Test
    fun `getDailyLog returns NOT_FOUND when no anchor`() = runTest {
    ...
    @Test
    fun `createDailyLog then getDailyLog returns the log`() = runTest {
        val ds = ds()
        val cycle = (ds.createCycle("2024-01-15") as ApiResult.Success).value
    ...
    @Test
    fun `createDailyLog duplicate date returns CONFLICT`() = runTest {
        val ds = ds()
        val cycle = (ds.createCycle("2024-01-15") as ApiResult.Success).value
        ds.createDailyLog("2024-01-15", cycle.id)
    ...
    @Test
    fun `createDailyLog unknown cycle returns VALIDATION_ERROR`() = runTest {
    ...
    @Test
    fun `createDailyLog date before cycle start returns VALIDATION_ERROR`() = runTest {
        val ds = ds()
        val cycle = (ds.createCycle("2024-01-15") as ApiResult.Success).value
    ...
    @Test
    fun `putOptionIds without anchor returns NOT_FOUND`() = runTest {
    ...
    @Test
    fun `putOptionIds sets and reads back emotions`() = runTest {
        val ds = ds()
        val cycle = (ds.createCycle("2024-01-15") as ApiResult.Success).value
        ds.createDailyLog("2024-01-15", cycle.id)
    ...
    @Test
    fun `putOptionId single-select sets energy`() = runTest {
        val ds = ds()
        val cycle = (ds.createCycle("2024-01-15") as ApiResult.Success).value
        ds.createDailyLog("2024-01-15", cycle.id)
    ...
    @Test
    fun `putOptionId null clears single-select`() = runTest {
        val ds = ds()
        val cycle = (ds.createCycle("2024-01-15") as ApiResult.Success).value
        ds.createDailyLog("2024-01-15", cycle.id)
    ...
    @Test
    fun `patchNotes without anchor returns NOT_FOUND`() = runTest {
    ...
    @Test
    fun `patchNotes sets and clears notes`() = runTest {
        val ds = ds()
        val cycle = (ds.createCycle("2024-01-15") as ApiResult.Success).value
        ds.createDailyLog("2024-01-15", cycle.id)
    ...
    @Test
    fun `patchNotes too long returns VALIDATION_ERROR`() = runTest {
        val ds = ds()
        val cycle = (ds.createCycle("2024-01-15") as ApiResult.Success).value
        ds.createDailyLog("2024-01-15", cycle.id)
    ...
    @Test
    fun `putPain without anchor returns NOT_FOUND`() = runTest {
    ...
    @Test
    fun `putPain sets and clears pain`() = runTest {
        val ds = ds()
        val cycle = (ds.createCycle("2024-01-15") as ApiResult.Success).value
        ds.createDailyLog("2024-01-15", cycle.id)
        ...
        ds.putPain("2024-01-15", listOf(org.homeflow.core.dto.PainLocationDto(migraineId, 7)))
        var log = (ds.getDailyLog("2024-01-15") as ApiResult.Success).value
    ...
    @Test
    fun `getSymptomCategories returns 10 categories`() = runTest {
    ...
    @Test
    fun `getPainRegions returns 5 regions`() = runTest {
    ...
    @Test
    fun `getPreferences returns default order initially`() = runTest {
    ...
    @Test
    fun `putPreferences saves custom order`() = runTest {
        val ds = ds()
    ...
    @Test
    fun `putPreferences unknown slug returns VALIDATION_ERROR`() = runTest {
        val ds = ds()
    ...
    @Test
    fun `deleteAccount wipes all user data`() = runTest {
        val ds = ds()
        ds.createCycle("2024-01-15")
        ds.deleteAccount()
